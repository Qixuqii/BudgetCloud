      ...
      <form onSubmit={handleSubmit} className="rounded-2xl bg-white p-7 shadow ring-1 ring-black/5">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <input type="number" min="0" step="0.01" value={amount} onChange={(e) => setAmount(e.target.value)} className="w-full rounded-xl border border-gray-300 px-3 py-3 text-sm" />
          </div>
        </div>
        <div className="mb-6">
        ...
        <div className="mb-6">
          ...
          <input type="date" value={date} onChange={(e) => setDate(e.target.value)} className="w-full rounded-xl border border-gray-300 px-3 py-3 text-sm" />
        </div>
