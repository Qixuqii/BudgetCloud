  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        setItems(rows || []);
        // If selected not in this month, default to today (clamped to month)
    ...
    <div className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-8 px-4 py-8 md:grid-cols-2">
      ...
      <div className="rounded-2xl bg-white p-6 shadow ring-1 ring-black/5">
        <div className="mb-4 flex items-baseline justify-between">
          <div>
            <h3 className="text-base font-semibold text-gray-900">Transactions for {new Date(selected).toLocaleDateString()}</h3>
