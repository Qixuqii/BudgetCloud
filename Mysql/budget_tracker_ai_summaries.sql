...
CREATE TABLE `ai_summaries` (
  ...
  `ledger_id` bigint NOT NULL COMMENT '针对哪个账本的总结',
  `month` char(7) NOT NULL COMMENT '格式为YYYY-MM 如 2027-07',
  `content` text NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `ai_ledger_id_idx` (`ledger_id`),
  CONSTRAINT `ai_ledger_id` FOREIGN KEY (`ledger_id`) REFERENCES `ledgers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
